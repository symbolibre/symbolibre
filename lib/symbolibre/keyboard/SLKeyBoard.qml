...
SLKeyBoardForm {
    ...
    buttonJ.onActivated: classicalSend(KeyCode.SLK_COLONEQ, KeyCode.SLK_NULL, KeyCode.SLK_J)
    ...
    buttonV.onActivated: classicalSend(KeyCode.SLK_PLUS, KeyCode.SLK_SIGMA, KeyCode.SLK_V)
