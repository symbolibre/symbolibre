        ...
        FocusScope {
            ...
            Label {
                ...
                text: {
                    graph.selectedCurve ?
                        graph.selectedCurve +
                        "(" + String(graph.cursorX.toPrecision(4)) + ") = " +
                        String(graph.cursorY.toPrecision(4)) : ""
                }
            }
            ...
            Label {
                ...
                text: "X = " + String(graph.cursorX.toPrecision(4))
            }
            Label {
                id: ytext
                visible: graph.mode == "Zoom"
                ...
                height: 20
                anchors.bottomMargin: 0
                text: "Y = " + String(graph.cursorY.toPrecision(4))
            }
        }
